        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                required
                placeholder="John"
                className="bg-white border border-[#E5E5E5] rounded-xl text-[#0A0A0A] text-sm px-3.5 py-3 placeholder-[#9CA3AF] focus:outline-none focus:border-[#C8FF00] transition-colors"
              />
            </div>
            <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              onChange={handleChange}
              required
              className="bg-white border border-[#E5E5E5] rounded-xl text-sm px-3.5 py-3 focus:outline-none focus:border-[#C8FF00] transition-colors appearance-none cursor-pointer"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="bg-white border border-[#E5E5E5] rounded-xl text-[#0A0A0A] text-sm px-3.5 py-3 placeholder-[#9CA3AF] focus:outline-none focus:border-[#C8FF00] transition-colors resize-none"
            />
          </div>
